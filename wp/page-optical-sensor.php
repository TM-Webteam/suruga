  ...
  <section class="hero core">
    <div class="containers flex aiC">
      <div class="hero__box">
        ...
        <div class="ctabtn">
          <div class="balloon"><span class="balloon__txt">製品の特長や概要が3分で分かる！</span></div>
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>catalog/1/" class="more thumb big bgY">製品資料ダウンロード</a>
        </div>
      </div>
  ...
  <section class="needs">
    <div class="containers">
      ...
      <div class="flex jcC gap30 card">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>cost/" class="card__box">
          <h3 class="card__box--ttl">装置製作のコスト削減をしたい</h3>
          <figure class="card__box--img"><img src="<?php echo assets_path() ?>img/top/img-needs01.jpg" alt="装置製作のコスト削減をしたい" loading="lazy" decoding="async" width="480" height="270"></figure>
        </a>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>accuracy/" class="card__box">
      ...
      ?>
        ...
        <a href="<?php the_permalink(); ?>" class="sec-news__box">
          <dl class="flex aiC gap30 sec-news__box--item">
            ...
            <dd><?php echo strip_tags(get_the_title()); ?></dd>
          </dl>
        </a>
