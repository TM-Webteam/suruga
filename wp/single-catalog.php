...
<main class="single-whitepaper bg-G">
  ...
  <section class="">
    <div class="containers flex">
      ...
      <div class="form__wrap">
        <div class="form__ttl">下記フォームの項目に入力いただき、<br>資料をダウンロードください。</div>
        <div id="aptoenqform">
        ...
        var arg = new enqarg();
        arg.id = "surugaost";
        arg.no = <?php echo CFS()->get('form_id'); ?>;
        enqform(arg);
        </script>
      </div>
  ...
  <section class="breadcrumb">
    <div class="containers">
      <ul class="flex fS">
        ...
        <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>catalog/">製品資料</a></li>
        <li><?php the_title(); ?></li>
      </ul>
    </div>
  </section>
