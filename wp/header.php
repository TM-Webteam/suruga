...
<?php endif; ?>
  ...
  <div class="in">
    <aside class="flex aiC inherit">
      <div class="in__logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo assets_path() ?>img/common/logo.svg" alt="駿河精機株式会社" loading="lazy" decoding="async" width="145" height="56"></a></div>
      <nav class="in__nav hpc-only">
        <ul class="flex jcE aiC">
          <li class="core"><a href="tel:0120789446" class="tel">0120-789-446</a>　平日9:00~18:00（土日祝は除く）</li>
          ...
          <li class="in__nav--list parent">
            <a href="#" class="pc disabled"><span>デモ機貸出</span></a>
            <ul class="pull">
              <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_m/">機器のみ</a></li>
              <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_v/">デモンストレーション（訪問）</a></li>
              <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_w/">デモンストレーション（ワーク送付）</a></li>
            </ul>
          </li>
        </ul>
      </nav>
  ...
  <nav class="nav-list hpc-only">
    <ul class="flex nav-list-box">
      ...
      <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>cost/" class="link">装置制作のコスト削減をしたい</a></li>
  ...
  <div id="gloval-nav" class="hsp-only">
    <ul class="list">
      ...
      <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>cost/">装置制作のコスト削減をしたい</a></li>
    ...
    <ul class="aside">
      <li><a href="tel:0120789446" class="tel">0120-789-446</a><br>平日9:00~18:00（土日祝は除く）</li>
      ...
      <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_m/" class="more small pc">機器のみ</a></li>
      <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_v/" class="more small pc">デモンストレーション（訪問）</a></li>
      <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>demo_w/" class="more small pc">デモンストレーション（ワーク送付）</a></li>
    </ul>
  </div>
</header>